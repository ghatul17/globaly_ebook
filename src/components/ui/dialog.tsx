...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-md translate-x-[-50%] translate-y-[-50%] bg-white shadow-2xl rounded-2xl p-8 max-h-[90vh] overflow-y-auto",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1.5 text-meta hover:bg-surface hover:text-dark transition-colors">
        <X size={16} />
