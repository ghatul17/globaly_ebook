  ...
  <footer className="bg-navy text-neutral-500 py-16 px-4">
   <div className="max-w-5xl mx-auto">
    <div className="grid sm:grid-cols-3 gap-12 mb-14">
     ...
     {/* Legal */}
     <div>
      <h4 className="text-neutral-300 text-xs font-semibold uppercase tracking-[0.15em] mb-5">Legal</h4>
      <ul className="space-y-3 text-sm text-neutral-500">
       <li><Link to="/privacy" className="hover:text-neutral-300 transition-colors">Privacy Policy</Link></li>
       <li><Link to="/terms" className="hover:text-neutral-300 transition-colors">Terms of Service</Link></li>
      </ul>
     </div>
    </div>
